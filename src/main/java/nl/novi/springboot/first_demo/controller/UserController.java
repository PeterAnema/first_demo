...
import nl.novi.springboot.first_demo.exception.BadRequestException;
...
public class UserController {
    ...
    public ResponseEntity<Object> updateUser(@PathVariable("username") String username, @RequestBody AppUser user) {
